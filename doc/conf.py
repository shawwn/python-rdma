# -*- coding: utf-8 -*-
#
# python-rdma documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'doc.module_data']
...
htmlhelp_basename = 'python-rdmadoc'
